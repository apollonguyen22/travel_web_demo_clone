            ...
            <nav className="navbar">
                <div className="navbar-container">
                    ...
                    <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                        ...
                        <li className="nav-item">
                            <Link to="/services" className="nav-links" onClick={closeMoblieMenu}>Services</Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/products" className="nav-links" onClick={closeMoblieMenu}>Products</Link>
                        </li>
                        <li>
                            <Link to="/sign-up" className="nav-links-mobile" onClick={closeMoblieMenu}>Sign up</Link>
                        </li>
                    </ul>
